...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(
            inplanes, inplanes*self.expansion, kernel_size=1, bias=False)
        ...
        self.conv3 = nn.Conv2d(inplanes*self.expansion,
...
class MobileLiteNet(nn.Module):
    def __init__(self, layers, num_classes, block=InvertedResidual):
...
def MobileLiteNet54(**kwargs):
    model = MobileLiteNet([4, 4, 6, 3], **kwargs)
    return model


def MobileLiteNet54_se(**kwargs):
    model = MobileLiteNet_se([4, 4, 6, 3], **kwargs)
    return model


def MobileLiteNet102(**kwargs):
    model = MobileLiteNet([3, 4, 23, 3], **kwargs)
    return model


def MobileLiteNet105_se(**kwargs):
    model = MobileLiteNet_se([4, 4, 23, 3], **kwargs)
    return model


def MobileLiteNet153(**kwargs):
    model = MobileLiteNet([3, 8, 36, 3], **kwargs)
    return model


def MobileLiteNet156_se(**kwargs):
    model = MobileLiteNet_se([4, 8, 36, 3], **kwargs)
    return model
